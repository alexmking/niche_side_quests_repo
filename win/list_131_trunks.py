...
# @raycast.title list 13.1 trunks
...
# Documentation:
# @raycast.description list 13.1 trunks (same as list_13.1_trunks_amk terminal alias)
...
os.system("C:\\Users\\aking\\amk\\tools\\alex_scripts\\list_13.1_trunks_amk.py")
