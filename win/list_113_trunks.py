...
# @raycast.title list 11.3 trunks
...
# Documentation:
# @raycast.description list 11.3 trunks (same as list_11.3_trunks_amk terminal alias)
...
os.system("C:\\Users\\aking\\amk\\tools\\alex_scripts\\list_11.3_trunks_amk.py")
