...
# Documentation:
# @raycast.description run cpp practice script via raycast
...
# os.system("D:\\git\\niche_side_quests_repo\\_universal\\scr-leet_morning_random.py " + arg1Difficulty + " " + arg2Category + " " + arg3TopProblem)
os.system("D:\\git\\niche_side_quests_repo\\_universal\\scr-leet_morning_random.py any "  + arg2Category + " onlytopproblems")
