...
# @raycast.title list 12.1 trunks
...
# Documentation:
# @raycast.description list 12.1 trunks (same as list_12.1_trunks_amk terminal alias)
...
os.system("C:\\Users\\aking\\amk\\tools\\alex_scripts\\list_12.1_trunks_amk.py")
