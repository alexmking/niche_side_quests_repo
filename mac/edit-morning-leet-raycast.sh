...
# @raycast.title Edit Morning Leet RaycastCommand
# @raycast.mode compact
# @raycast.description Open morning-leet.py file in VS Code for quick edits (NOT TO BE CONFUSED WITH THE RAYC-PART of morning-leet (which is the python script for triggering the scr-leet_mroning_random.py 100% through raycasts app))
...
# FILE="/Users/alexking/amk/tools/GIT_STUFF/niche_side_quests_repo/_universal/scr-leet_morning_random.py"
FILE="/Users/alexking/amk/tools/GIT_STUFF/niche_side_quests_repo/mac/morning-leet.py"
