...
# Documentation:
# @raycast.description standard leet probs for group1 (same as standardleet2 terminal alias)
...
os.system("/Users/alexking/amk/tools/GIT_STUFF/niche_side_quests_repo/_universal/scr-leet_morning_random.py easymed group2 onlytopproblems")
