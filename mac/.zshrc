...
alias fzfcurrentkeyboardbindings="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfkeyboardbindings="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfbindings="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfkeyboard="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfkeyb="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfkb="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
alias fzfshortcuts="cat /usr/local/bin/alexScripts/current_keyboard_bindings.txt | fzf"
